...
INWHEEL_UP_ACTUATOR_CFG = IdentifiedActuatorCfg(
    ...
    stiffness={".*": 0.125}, # 강성 : 관절이 외부 힘에 더 잘 저항
    damping={".*": 0.0128},    # 감쇠 : 진동과 불안정한 움직임을 줄임임
    armature={".*": 6.9e-5 * 81},
    friction_static=0.3,
    activation_vel=0.2,
...
BERKELEY_HUMANOID_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=r"C:\Users\rnjsg\IsaacLab\isaac_berkeley_humanoid\exts\berkeley_humanoid\berkeley_humanoid\assets\Robots\robot.usd",
