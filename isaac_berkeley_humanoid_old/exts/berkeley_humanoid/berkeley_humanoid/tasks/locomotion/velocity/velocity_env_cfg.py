...
class CommandsCfg:
    ...
    base_position = mdp.UniformPoseCommandCfg(
        ...
        ranges=mdp.UniformPoseCommandCfg.Ranges(pos_x=(0.0, 0.0), pos_y=(0.0, 0.0), pos_z=(0.0, 0.0), roll=(0.0, 0.0), pitch=(-0.4, -0.4), yaw=(0.0, 0.0))
    )
    # base_position = mdp.UniformPoseCommandCfg(
    #     asset_name="robot",
    #     body_name=".*upper_leg",
...
class RandomizationCfg:
    ...
    #     func=mdp.randomize_rigid_body_mass,
    #     mode="startup",
    #     params={"asset_cfg": SceneEntityCfg("robot", body_names="base"), "mass_distribution_params": (-0.1, 0.1),
    #             "operation": "add"},
    # )
    ...
    #     mode="startup",
    #     params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*"]), "pos_distribution_params": (-0.02, 0.02),
    #             "operation": "add"},
    # )
